...
$(function () {
    ...
    ***************************/
    $(document).on('click', 'a[href^="#"]', function (event) {
        ...
        // Ignore dummy anchors like href="#" or href="#."
    ...
    ***************************/
    ...
    $('a:not(".mil-choose , .mil-more , .mil-drag , .mil-accent-cursor"), input , textarea').mouseover(function () {
        gsap.to($(cursor), .2, {
            scale: 0,
            ease: 'sine',
        });
    ...
    $('a:not(".mil-choose , .mil-more , .mil-drag , .mil-accent-cursor"), input, textarea').mouseleave(function () {
        gsap.to($(cursor), .2, {
            scale: 1,
            ease: 'sine',
        });
